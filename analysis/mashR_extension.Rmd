...
$$
\rho_e \sigma_e^2 = \pi_1(\rho_G^* \sigma_G^2 + \rho_e^*\sigma_e^2) + (1-\pi_1)\rho_e^* \sigma_e^2
$$

it can rewritten as:

$$
\pi_1 = (\rho_e - \rho_e^*) \cdot \dfrac{\sigma_e^2}{\rho_G^* \sigma_G^2}
$$
...
compute_mixture_posterior <- function(beta_hat_matrix, n, pi0, 
                                      sigma_G2, sigma_e2, rho_G, rho_e) {
...
post_res <- compute_mixture_posterior(beta_hat, n, pi0, sigma_G2, sigma_e2, rho_G, rho_e=0.1)
...
for (i in seq_along(true_pi0_values)) {
  ...
  estimated_pi0s[i] <- estimate_pi0_mle_approx(
    beta_hat, n, sigma_G2, sigma_e2, rho_G_model, rho_e
  )
}
