...
plot(abs(ress[,"score1.x"]), abs(ress[,"score.Z"]), pch=20,
     ylim=c(0,55), xlim=c(0,5),col=3,main="sigma1=0.05",
...
$$
Tscore(Y_1 \sim X) = \dfrac{\alpha \beta_1}{\sigma_1^2+\beta_1^2\sigma_0^2}
$$
On the other hand,  we have:
$$
Tscore(Z \sim X) = \dfrac{\alpha}{\sigma_0^2}
$$
So the expected ratio between the two should be:
$$
\dfrac{Tscore(Z \sim X)}{Tscore(Y_1 \sim X) } = 1 + \dfrac{\sigma_1^2}{\sigma_0^2 \beta_1}
$$
