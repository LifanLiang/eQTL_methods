...
Most parameters are fixed during simulation. We set $\alpha = 0.2$, $\beta_1 = 0.3$, $\beta_2 = 0.2$, and $\sigma_1 = 0.4$. We compared the t score and P values of regressing X against Y versus X against X. Green dots are from $Y_1 \sim X$. Red dots are from $Y_2 \sim X$.

```{r,echo=F}
library(ggplot2)
par(mfrow=c(1,3))
ress <- do.call(rbind, lapply(1:100,function(x){sim_factor(eps1=0.05)}))
