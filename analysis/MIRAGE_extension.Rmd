...
### Different categories of risk for genes.
...
for (i in 1:N) {
  ...
  mirage.pip.genegroup[i] <- comp.gene(beta.hat[i,], se.var[i,], C[i,], pi=res.genecat$pi, mu, sigma, delta=res.genecat$delta)$post.gene
}
